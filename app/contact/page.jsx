...
const info = [
    {
        icon: <FaPhoneAlt />,
        title: 'Phone',
        description: '+91 6282259552'
    },
    {
        icon: <FaEnvelope />,
        title: 'Email',
        description: 'gautham07049@gmail.com'
    },
    {
        icon: <FaMapMarkerAlt />,
        title: 'Address',
...
const scriptURL =
    "https://script.google.com/macros/s/AKfycbz9jMg3-sCsYEqvfyphaUdzQEEtZZaop1gN4Xt_0K73l9dUUchnIqxyKWCwpbWJW5fORQ/exec";
