            ...
            <div className="container mx-auto">
                ...
                >
                    ...
                    <div className="w-full">
                                ...
                                <ScrollArea className="min-h-[400px]">
                                    <ul className=" grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                                        {experience.items.map((item, index) => {
                                            return <li key={index} className="bg-secondary min-h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-start lg:items-start gap-1">
                        ...
                        { /*  Certifications*/}
                        <TabsContent value="certifications" className="w-full min-h-[550px]">
