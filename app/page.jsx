    ...
    <div className="container h-full mx-auto">
      <div className="flex flex-col items-center justify-between xl:flex-row xl:pt-8 xl:pb-24">
        ...
        <div className="order-2 text-center xl:text-left xl:order-none">
          <span className="text-xl ">Bachelor of Engineering Student</span>
          <h1 className="mb-6 h1">Hello, I'm<br />
            <span className="gradient-text">Gautham</span></h1>
          <p className="max-w-[500px] mb-9 text-white/80 ">I'm a final-year B.E. student and a cybersecurity and networking enthusiast, passionate about building secure systems and exploring real-world network challenges.</p>
          {/* Button and social account  */}
          <div className="flex flex-col items-center gap-8 xl:flex-row">
            <Button asChild variant="outline" size="lg" className="flex items-center gap-2 uppercase">
              <a href="/assets/resume/Gautham-P-Kini.pdf" download>
